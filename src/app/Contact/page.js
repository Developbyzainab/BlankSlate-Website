"use client"; // agar aapko hooks ya state use karna hai
...
<section className='w-full h-auto relative'>
   ...
   <section className="w-full min-h-screen  px-6 md:px-20 py-20">
      ...
      {/* Bottom Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-70 items-start">

        {/* Left Info */}
        <div className="space-y-10 ml-10">

          <div>
            <h2 className="text-5xl font-light">Just Say.</h2>
            <p className="mt-2 text-sm">HELLO@BLANKSLATE.COM</p>
          </div>

          <div>
            <h2 className="text-5xl font-light">oR cALL.</h2>
          ...
          <div>
            <h2 className="text-5xl font-light">oUR oFFICE.</h2>
            <p className="mt-2 text-sm">
          ...
          <div>
            <h2 className="text-5xl font-light">fOLLOW uS.</h2>
            <p className="mt-2 text-sm">
              BEHANCE.DRIBBLE.FACEBOOK.INSTAGRAM.LINKEDIN.YOUTUBE.
            </p>
          </div>
  ...
  <Image
    ...
    width={420}
    height={500}
    className="w-full h-140 object-cover block"
  />
</div>

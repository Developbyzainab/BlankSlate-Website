...
<button className="cursor-pointer text-white text-lg transition hover:text-gray-300">
Let's Talk
</button>
...
<div className="w-full bg-white h-[70vh] relative transition-all duration-500 ease-in-out pb-10">
...
<div className="flex flex-col gap-4 text-gray-500 items-center animate-[fadeIn_0.8s_ease]">
